...
function marck() {
    if (move == true && atak == false) {
        document.getElementById('atak').classList.remove('golden');
        document.getElementById('move').classList.add('golden');
    } else if (atak == true && move == false) {
        document.getElementById('move').classList.remove('golden');
        document.getElementById('atak').classList.add('golden');
    }
}
